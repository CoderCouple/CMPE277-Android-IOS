...
public class TenDaySummaryAdapter extends RecyclerView.Adapter<TenDaySummaryAdapter.ViewHolder> {
    ...
    @Override
    public TenDaySummaryAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(TenDaySummaryAdapter.ViewHolder viewHolder, int position) {
